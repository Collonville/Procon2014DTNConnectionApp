...
public class DTNMessageCollection {
	...
	public synchronized static void addData(String deviceName, String deviceIP, String chatMessage, String time, String hash, String latitude, String longitude ,String isMoving) {
