...
public class WifiConfigurationNew extends WifiConfiguration {
	...
	public void setIsIBSS(boolean val) throws NoSuchFieldException,
			IllegalArgumentException, IllegalAccessException {
		Field fIsIBSS = wc.getField("isIBSS");
		fIsIBSS.set(this, val);
	}

	public void setFrequency(int freq) throws NoSuchFieldException,
			IllegalArgumentException, IllegalAccessException {
		Field fFreq = wc.getField("frequency");
		fFreq.set(this, freq);
	}

	public void setIpAssignment(String assign) throws SecurityException,
	...
	public void setGateway(InetAddress gateway) throws SecurityException,
			IllegalArgumentException, NoSuchFieldException,
	...
	public void setDNS(InetAddress dns) throws SecurityException,
			IllegalArgumentException, NoSuchFieldException,
			IllegalAccessException {
		Object linkProperties = getField(this, "linkProperties");
		if (linkProperties == null)
